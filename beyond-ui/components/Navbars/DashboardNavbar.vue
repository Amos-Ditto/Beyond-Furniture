<template>
	...
	>
		<div class="left-nav flex flex-row items-center sm:justify-between gap-x-4 col-span-2 xl:col-span-1">
			...
			>
				<div class="i-mdi-magnify text-xl text-gray-700 transition duration-200"></div>
			</div>
		</div>
		<div class="right-nav flex flex-row items-center justify-end gap-x-4 sm:gap-x-6 col-span-1">
